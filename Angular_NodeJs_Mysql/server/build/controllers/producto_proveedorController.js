...
class Producto_proveedorController {
    ...
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const producto_proveedor = yield pool.query('SELECT * FROM producto');
    ...
    getOne(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const producto_proveedor = yield pool.query('SELECT * FROM producto WHERE cod_producto =?', [id]);
...
exports.producto_proveedorController = new Producto_proveedorController();
