    ...
    GamesController.prototype.list = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, pool.query('SELECT * FROM games')];
                    case 1:
                        games = _a.sent();
                        res.json(games);
                        return [2 /*return*/];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = req.params.id;
                        return [4 /*yield*/, pool.query('SELECT * FROM ng_games_db.games WHERE ID =?', [id])];
                    case 1:
                        games = _a.sent();
                        if (games.length > 0) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    return [4 /*yield*/, pool.query('INSERT INTO games set ?', [req.body])];
                    case 1:
                        //console.log(req.body);
                        _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = req.params.id;
                        return [4 /*yield*/, pool.query('UPDATE ng_games_db.games set ? WHERE  id=?', [req.body, id])];
                    case 1:
                        _a.sent();
